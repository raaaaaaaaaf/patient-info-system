...
export default function SeniorRecordPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = [];
        const dataRef = query(collection(db, "recordData"), where("type", "==", "Senior Citizen"));
  ...
  return (
    <>
      <Helmet>
        <title> Senior Citizen's Record | Patient Information System </title>
      </Helmet>
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell align="left">
                              {new Date(bod.seconds * 1000).toLocaleDateString(
                                "en-US"
                              )}
                            </TableCell>
